...
/** source: /home/daniel/projekty/quickstart/quickstart/app/UI/Post/show.latte */
final class Template_de307a7b7b extends Latte\Runtime\Template
{
	public const Source = '/home/daniel/projekty/quickstart/quickstart/app/UI/Post/show.latte';
...
<div class="date">';
		echo LR\Filters::escapeHtmlText(($this->filters->date)($post->created_at, 'F j, Y')) /* line 9 */;
		echo '</div>
