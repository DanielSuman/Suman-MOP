...
/** source: /home/daniel/projekty/quickstart/quickstart/app/UI/Front/@layout.latte */
final class Template_ed387b9f80 extends Latte\Runtime\Template
{
	public const Source = '/home/daniel/projekty/quickstart/quickstart/app/UI/Front/@layout.latte';
...
';
		if ($user->isLoggedIn()) /* line 14 */ {
			...
			echo '</strong> | <a href="';
			echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link(':Front:Sign:out')) /* line 15 */;
			echo '">Sign-out</a></li>
';
		} else /* line 16 */ {
			...
			echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link(':Front:Sign:up')) /* line 17 */;
			echo '">Sign-Up</a></li>
';
		}
		echo '		<li><a href="';
